<x-app-layout>
    ...
    <link rel="stylesheet" href="{{ asset('css/artikel/artikel_edit.css') }}">
    ...
    <div style="padding:40px;">
        ...
        <form action="{{ route('artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="date" name="tanggal_publish" value="{{ $artikel->tanggal_publish }}">
            </div>
            ...
            <div>
                ...
                @if($artikel->gambar)
                    <img src="{{ asset('storage/artikel/'.$artikel->gambar) }}" width="100"><br><br>
                @endif
